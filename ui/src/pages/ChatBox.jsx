...
import FloatingButton from "../components/drawer/FloatingButton";
import { Collapse, Slide } from "@mui/material";
import CreateChannel from "../components/drawer/CreateChannel";
  ...
  return (
    <Box display="flex" flexDirection="row" height="100vh">
      ...
      <Box display="flex" flexDirection="column" width="75%" maxHeight="100vh">
        <ContactBar />
        <Box
          sx={{ overflow: "auto", bgcolor: "blanchedalmond", height: "100%" }}
        >
